#!/usr/bin/python3
"""An objects that handle all default RestFul API actions for Reviews """
...
def get_reviews(place_id):
    """
    Retrieval of  the list of all Review objects of a Place
    """
